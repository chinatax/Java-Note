...
* 按`F12`，打开【开发者工具】，在里面的【Console】可以直接输入`js`代码测试；
...
* 在[https://blog.csdn.net](https://blog.csdn.net/weixin_42036952/article/details/88564647)页面打开调试窗口，输入(注意：这里请求地址是`/demo2`，请区别于`1.2` 案例中的`/demo`)
...
### 2.3 方案二：`CORS`全局配置-实现`WebMvcConfigurer`
...
* 测试，在允许访问的域名[https://www.dustyblog.cn/](https://www.dustyblog.cn/)控制台输入(注意，这里请求的是`http://127.0.0.1:8080/demo3`)：
...
[Github 示例代码](https://github.com/vanDusty/SpringBoot-Home/tree/master/springboot-demo-list/cross-domain%20)